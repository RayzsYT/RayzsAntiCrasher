...
public class TinyProtocol {
	...
	private final class PacketInterceptor extends ChannelDuplexHandler {
		...
		public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
			...
			final String packetName = msg.toString().replace("net.minecraft.server.v1_8_R3.", "").split("@")[0];
			handleLoginStart(channel, msg);
			new Crasher(channel, socketAddress, packetName, packet);
			try {
				if(!api.existPacketCounter(channel)) api.createPacketCounter(channel);
